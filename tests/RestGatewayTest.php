...
class RestGatewayTest extends GatewayTestCase
{
    ...
    public function testCapture()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestCaptureRequest', $request);
    ...
    public function testRefund()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestRefundRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $endPoint = $request->getEndpoint();
    ...
    public function testFetchTransaction()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestFetchTransactionRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $data = $request->getData();
    ...
    public function testListPlan()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestListPlanRequest', $request);
    ...
    public function testFetchPurchase()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestFetchPurchaseRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $data = $request->getData();
        $this->assertEmpty($data);
    }
    ...
    public function testListPurchase()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestListPurchaseRequest', $request);
    ...
    public function testRefundCapture()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestRefundCaptureRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $endPoint = $request->getEndpoint();
    ...
    public function testVoid()
    {
        ...
        $this->assertInstanceOf('\Petcircle\PayPal\Message\RestVoidRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $endPoint = $request->getEndpoint();
